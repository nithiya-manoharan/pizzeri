            ...
            <div className="row">
                {pizzas.map(pizzas => (
                    ...
                    <div className="card h-100">
                        <img src={pizzas.image} height={300} alt={pizzas.name} className="card-img-top" />
                        ...
                        <button  className="btn btn-danger me-2" onClick={()=> handleDelete(pizzas.id)}>DELETE</button>
                        </div>
                        </div>
                    </div>
                ))}
